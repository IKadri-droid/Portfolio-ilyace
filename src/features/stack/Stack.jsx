...
const technologies = [
  { name: 'Kali Linux', icon: SiKalilinux, description: 'Tests d\'intrusion & Audit' },
  { name: 'Python', icon: SiPython, description: 'Scripting & Automatisation' },
  { name: 'Linux', icon: SiLinux, description: 'Administration Système' },
  { name: 'GitHub', icon: SiGithub, description: 'Gestion de Code & Collaboration' },
  { name: 'VS Code', icon: VscCode, description: 'Environnement de Développement' },
  { name: 'Git', icon: SiGit, description: 'Contrôle de Version' },
  { name: 'Docker', icon: SiDocker, description: 'Isolation & Sécurité Container' },
  { name: 'Bash', icon: SiGnubash, description: 'Scripting & Automatisation' },
];

const Stack = ({ className }) => (
  <section id="stack" className={`min-h-screen py-32 px-8 sm:px-12 flex flex-col justify-center ${className}`}>
    <div className="mb-16">
      <h2 className="text-[16px] font-semibold tracking-[0.2em] text-indie-primary uppercase mb-2">Expertise</h2>
      <h3 className="text-4xl font-serif text-indie-text transition-colors duration-500">Arsenal Technique</h3>
